...
Ban đầu, mọi thứ có vẻ đơn giản khi áp hàm lượng giác vào sin(x)_cos(x) = 1/2 \* sin(2_x). Khi đó, x sẽ bằng 1/2 \* arcsin(2\*kết quả). Tuy nhiên số này sẽ không đủ để khôi phục lại được đúng flag ban đầu.
...
Flag: W1{B4by\_m4th\_f0r\_LLL\_0dbb94edb18d7cba7b2bb20f9e}

#### Council of Sheep

The beauty of math is that it always tell the truth

Attachment: _the\_council\_of\_sheep.tar.gz_
...
* oh that is unintended, so sad, when I originally created this challenge, I considered to leave only the decrypt functionality (do\_task)
